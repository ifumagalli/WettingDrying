...
A_adve = ass_adve(vertices,elements,un,vn,1,1,2);
...
M=ass_massa(vertices,elements,1,1,2);

% matrice associata alle resistenze al fondo

% Fr = ass_massa(vertices,elements,1,coeff,2);
...
[M_Lh,Lh,f_Lh] = assem_mat_GLS_simm1(vertices,elements,boundaries,g,un,vn,cn,coeff,f1,f2,f3,theta,dt,h_k,omega,time,un_old,vn_old,cn_old,un,vn,drynodes,save_path);
